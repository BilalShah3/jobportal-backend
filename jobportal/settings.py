...
ALLOWED_HOSTS = ['nookri.herokuapp.com', '127.0.0.1', 'localhost']
...
#configuration for static files storages
...
# os.environ['PROJ_LIB'] = VIRTUAL_ENV_BASE + '/Lib/site-packages/osgeo/data/proj'
